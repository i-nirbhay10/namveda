...
export function NameResult({ suggestion }: NameResultProps) {
  ...
  const handleFavorite = () => {
    ...
    toast({
      ...
      description: `${suggestion.name} ${isFavorited ? "removed from" : "added to"} your favorites.`,
    })
  }
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex gap-2">
            <Button variant="ghost" size="sm" onClick={handlePronunciation} className="h-8 w-8 p-0">
